...
categories: []
tags: []
summary: "Reflections on psychological triggers"
---
...
#pagecolour <- unname(slumdown::slum_palette("kunoichi")["pagecolour"])
#slumdown::slum_plot_background(palette = "kunoichi", name = "pagecolour")
```

<p align=center>*[content warnings: rape, panic attacks, triggers]*</p>
...
My experience with trauma flashbacks is that the trigger itself is often something very small. 
Triggers can be absurdly, stupidly small. A man was giving a talk and made a joke about sex. It wasn't an especially risque joke, it wasn't an offensive joke. It was just a joke. People make jokes all the time.
