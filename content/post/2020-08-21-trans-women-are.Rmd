...
-   So it's okay to call trans women natal males?
    ...
    **In almost every context the appropriate term to refer to us is simply "trans woman". As I mentioned earlier, the use terms like "natal male" and "biological male" in everyday language is not neutral: rather it is a rhetorical way to avoid having to call us women. It is misgendering, pure and simple. The legitimate use case for the term "natal male" is pretty narrow, and is mostly restricted to situations when precision is needed in administrative or scientific contexts. Outside those contexts, it's completely inappropriate language.**
